...
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_ALLOW_DIRECT_FALLBACK;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_AUTH_ENABLED;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_AUTH_PASSWORD;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_AUTH_USERNAME;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_ENABLED;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_HOST;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_HTTPS;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.PROXY_PORT;
...
import app.argusos.extension.shared.requests.proxy.CronetFallbackHttpURLConnection;
import app.argusos.extension.shared.requests.proxy.CronetHttpURLConnection;
import app.argusos.extension.shared.requests.proxy.ProxyFallbackHttpURLConnection;
