...
import static app.argusos.extension.shared.privacy.LinkSanitizer.replaceWithShortenedURL;
import static app.argusos.extension.shared.privacy.LinkSanitizer.returnSanitizedURLFromURI;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.REPLACE_LINKS_WITH_SHORTENER;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.REPLACE_MUSIC_LINKS_WITH_YOUTUBE;
import static app.argusos.extension.shared.settings.SharedYouTubeSettings.SANITIZE_SHARING_LINKS;
