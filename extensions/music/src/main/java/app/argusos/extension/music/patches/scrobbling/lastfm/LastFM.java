...
package app.argusos.extension.music.patches.scrobbling.lastfm;
...
import app.argusos.extension.music.patches.scrobbling.ScrobbleManager;
        ...
        ScrobbleManager.getInstance().runOnBackgroundThread(() -> {
            try {
                ...
                if (ex.getErrorCode() == 9) {
                    ...
                    app.argusos.extension.music.settings.Settings.LASTFM_SESSION_KEY.resetToDefault();
                    app.argusos.extension.music.settings.Settings.LASTFM_USERNAME.resetToDefault();
                }
            } catch (Exception ex) {
