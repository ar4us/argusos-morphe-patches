...
import static app.argusos.extension.shared.sponsorblock.objects.CategoryBehaviour.IGNORE;
import static app.argusos.extension.shared.sponsorblock.objects.CategoryBehaviour.MANUAL_SKIP;
import static app.argusos.extension.shared.sponsorblock.objects.CategoryBehaviour.SKIP_AUTOMATICALLY;
import static app.argusos.extension.shared.sponsorblock.objects.CategoryBehaviour.SKIP_AUTOMATICALLY_ONCE;
...
import app.argusos.extension.shared.settings.preference.SeekBarPreference;
import app.argusos.extension.shared.settings.preference.SeekBarPreference.SeekBarConfig;
import app.argusos.extension.shared.sponsorblock.SegmentPlaybackController.SponsorBlockDuration;
...
import app.argusos.extension.youtube.patches.AutoCaptionsPatch.AutoCaptionsStyle;
import app.argusos.extension.youtube.patches.ChangeFormFactorPatch.FormFactor;
import app.argusos.extension.youtube.patches.ChangeFormFactorPatch.TabletLayoutInPlayerAvailability;
import app.argusos.extension.youtube.patches.ChangeHeaderPatch.HeaderLogo;
import app.argusos.extension.youtube.patches.ChangeStartPagePatch.StartPage;
import app.argusos.extension.youtube.patches.ExitFullscreenPatch.FullscreenMode;
import app.argusos.extension.youtube.patches.LegacyPlayerControlsPatch.RestoreOldPlayerButtonsAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerAnyModernAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerHideOverlayButtonsAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerHorizontalDragAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerHorizontalDragPlaybackAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerHorizontalRepositioningAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerOverlayOpacityAvailability;
import app.argusos.extension.youtube.patches.MiniplayerPatch.MiniplayerType;
import app.argusos.extension.youtube.patches.OpenShortsInRegularPlayerPatch.ShortsPlayerType;
import app.argusos.extension.youtube.patches.OpenVideosFullscreenHookPatch.OpenFullscreenMode;
import app.argusos.extension.youtube.patches.VersionCheckPatch;
import app.argusos.extension.youtube.patches.components.LayoutComponentsFilter.ExpandableCardStyle;
import app.argusos.extension.youtube.patches.components.PlayerFlyoutMenuComponentsFilter.HideAudioFlyoutMenuAvailability;
import app.argusos.extension.youtube.patches.spoof.SpoofVideoStreamsPatch.SpoofClientAv1Availability;
import app.argusos.extension.youtube.patches.theme.ThemePatch.SplashScreenAnimationStyle;
import app.argusos.extension.youtube.patches.voiceovertranslation.VoiceOverTranslationPatch;
import app.argusos.extension.youtube.patches.voiceovertranslation.VoiceOverTranslationPatch.MyMemoryServiceAvailability;
import app.argusos.extension.youtube.patches.voiceovertranslation.VoiceOverTranslationPatch.OpenRouterServiceAvailability;
import app.argusos.extension.youtube.sponsorblock.SponsorBlockSettings;
import app.argusos.extension.youtube.sponsorblock.YouTubeSponsorBlockConfig;
import app.argusos.extension.youtube.swipecontrols.SwipeControlsConfigurationProvider.SwipeOverlayStyle;
import app.argusos.extension.youtube.swipecontrols.SwipeControlsConfigurationProvider.SwipeSpeedStep;
import app.argusos.extension.youtube.videoplayer.PlayAllButton.PlaylistIDPrefix;
...
public class Settings extends SharedYouTubeSettings {
    ...
    public static final StringSetting MORPHE_MUSIC_PACKAGE_NAME = new StringSetting("morphe_music_package_name", "app.argusos.android.apps.youtube.music", true, parent(OVERRIDE_YOUTUBE_MUSIC_BUTTONS));
