...
package app.argusos.extension.youtube.patches.voiceovertranslation;

import static app.morphe.extension.shared.StringRef.str;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.DRAWABLE_CHECKMARK;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.DRAWABLE_CHECKMARK_BOLD;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.ID_MORPHE_CHECK_ICON;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.ID_MORPHE_CHECK_ICON_PLACEHOLDER;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.ID_MORPHE_ITEM_TEXT;
import static app.argusos.extension.shared.settings.preference.CustomDialogListPreference.LAYOUT_MORPHE_CUSTOM_LIST_ITEM_CHECKED;
import static app.argusos.extension.youtube.patches.voiceovertranslation.TranscriptTranslator.TRANSLATION_SERVICE_GOOGLE;
import static app.argusos.extension.youtube.patches.voiceovertranslation.TranscriptTranslator.TRANSLATION_SERVICE_MY_MEMORY;
import static app.argusos.extension.youtube.patches.voiceovertranslation.TranscriptTranslator.TRANSLATION_SERVICE_OPENROUTER;
import static app.argusos.extension.youtube.patches.voiceovertranslation.VoiceOverTranslationPatch.TTS_ENGINE_SYSTEM;
import static app.argusos.extension.youtube.videoplayer.LegacyPlayerControlButton.fadeInDuration;
import static app.argusos.extension.youtube.videoplayer.LegacyPlayerControlButton.getDialogBackgroundColor;
...
import app.argusos.extension.youtube.shared.PipDismissHelper;
