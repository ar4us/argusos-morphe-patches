...
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_BOARD;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_BOOTLOADER;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_BRAND;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_CPU_ABI2;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_DEVICE;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_DISPLAY;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_FINGERPRINT;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_HARDWARE;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_HOST;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_ID;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_MANUFACTURER;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_MODEL;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_PRODUCT;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_RADIO;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_TAGS;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_TYPE;
import static app.argusos.extension.shared.checks.PatchInfo.Build.PATCH_USER;
