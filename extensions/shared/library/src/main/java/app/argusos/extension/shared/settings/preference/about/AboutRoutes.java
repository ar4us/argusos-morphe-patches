package app.argusos.extension.shared.settings.preference.about;

import static app.argusos.extension.shared.requests.Route.Method.GET;
import static app.argusos.extension.shared.settings.preference.about.MorpheAboutPreference.CREDITS_LINK;
