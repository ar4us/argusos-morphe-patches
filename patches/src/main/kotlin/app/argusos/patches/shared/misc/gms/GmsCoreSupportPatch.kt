...
import app.argusos.patches.shared.misc.gms.Constants.ACTIONS
import app.argusos.patches.shared.misc.gms.Constants.AUTHORITIES
import app.argusos.patches.shared.misc.gms.Constants.PERMISSIONS
...
internal const val EXTENSION_CLASS =
    "Lapp/argusos/extension/shared/patches/GmsCoreSupportPatch;"
...
fun gmsCoreSupportResourcePatch(
    ...
    execute {
        ...
        screen.addPreferences(
            ...
            SwitchPreference("argusos_gms_core_battery_optimization_dialog")
        )
