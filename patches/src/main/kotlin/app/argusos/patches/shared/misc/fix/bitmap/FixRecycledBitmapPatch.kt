...
package app.argusos.patches.shared.misc.fix.bitmap
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/shared/patches/FixRecycledBitmapPatch;"
...
val fixRecycledBitmapPatch = bytecodePatch(
    ...
    execute {
        Fingerprint(
            ...
            custom = { _, classDef ->
                !classDef.type.startsWith("Lapp/argusos/extension")
            }
