...
package app.argusos.patches.shared.misc.spoof.appversion
...
fun baseSpoofAppVersionPatch(
    ...
    sharedExtensionClass: String = "Lapp/argusos/extension/shared/spoof/SpoofAppVersionPatch;",
    ...
    execute {
        ...
        preferenceScreen.addPreferences(
            noTitleUnsortedPreferenceCategory(
                SwitchPreference("argusos_spoof_app_version", summary = true),
                listPreference()
            )
        )
