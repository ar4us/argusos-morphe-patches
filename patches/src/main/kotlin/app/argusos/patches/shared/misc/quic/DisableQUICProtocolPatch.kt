...
package app.argusos.patches.shared.misc.quic
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/shared/patches/DisableQUICProtocolPatch;"
...
internal fun disableQUICProtocolPatch(
    ...
    execute {
        preferenceScreen.addPreferences(
            SwitchPreference("argusos_disable_quic_protocol")
        )
