...
private const val LAUNCHER_ADAPTIVE_MONOCHROME_PREFIX = "argusos_adaptive_monochrome"
...
internal const val EXTENSION_CLASS = "Lapp/argusos/extension/shared/patches/CustomBrandingPatch;"
    ...
    execute {
        ...
        if (useCustomIcon) {
            preferences += ListPreference(
                ...
                tag = "app.argusos.extension.shared.settings.preference.IconListPreference",
                entriesKey = "argusos_custom_branding_icon_custom_entries",
                entryValuesKey = "argusos_custom_branding_icon_custom_entry_values"
            )
            preferences += ListPreference(
                key = "argusos_custom_branding_notification_icon",
                tag = "app.argusos.extension.shared.settings.preference.NotificationIconListPreference",
                entriesKey = "argusos_custom_branding_notification_icon_custom_entries",
                entryValuesKey = "argusos_custom_branding_notification_icon_custom_entry_values"
            )
        } else {
            preferences += ListPreference(
                key = "argusos_custom_branding_icon",
