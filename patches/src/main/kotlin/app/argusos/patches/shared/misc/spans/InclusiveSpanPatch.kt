...
package app.argusos.patches.shared.misc.spans
...
import app.argusos.patches.shared.SpannableStringBuilderFingerprint
...
internal const val EXTENSION_SPANS_CLASS = "Lapp/argusos/extension/shared/patches/spans/InclusiveSpanPatch;"

internal const val EXTENSION_FILTER_ARRAY = "[Lapp/argusos/extension/shared/patches/spans/SpanFilter;"
