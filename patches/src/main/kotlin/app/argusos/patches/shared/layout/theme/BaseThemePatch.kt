...
internal fun baseThemeResourcePatch(
    ...
    execute {
        ...
        if (isMaterialYouDark) {
            ...
            createNotifDrawable(resDir, "drawable/argusos_notif_dot_dark.xml", darkDotColor, "oval")
            createNotifDrawable(resDir, "drawable/argusos_notif_count_dark.xml", darkCountBgColor, "rectangle", hasCorners = true)
                ...
                document(stylesFile).use { document ->
                    ...
                    resources.forEachChildElement { style ->
                        ...
                        val overrides: Map<String, String> = when (style.getAttribute("name")) {
                            "PivotBar.Dark" -> mapOf(
                                "dotBackground" to "@drawable/argusos_notif_dot_dark",
                                "countBackground" to "@drawable/argusos_notif_count_dark"
                            )
