...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/shared/patches/EnableDebuggingPatch;"
...
internal fun enableDebuggingPatch(
    ...
    execute {
        ...
        preferences.addAll(
            listOf(
                SwitchPreference("argusos_debug_stacktrace", summary = true),
                SwitchPreference("argusos_debug_toast_on_error"),
                NonInteractivePreference(
                    "argusos_debug_export_logs",
