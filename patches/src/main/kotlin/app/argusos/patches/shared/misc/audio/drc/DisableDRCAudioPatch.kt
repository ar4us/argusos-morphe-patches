package app.argusos.patches.shared.misc.audio.drc
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/shared/patches/DisableDRCAudioPatch;"
...
internal fun disableDRCAudioPatch(
    ...
    execute {
        preferenceScreen.addPreferences(
            SwitchPreference("argusos_disable_drc_audio")
        )
