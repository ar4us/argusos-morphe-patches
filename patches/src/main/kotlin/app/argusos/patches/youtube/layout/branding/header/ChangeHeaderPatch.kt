...
import app.argusos.patches.shared.layout.branding.header.CUSTOM_HEADER_RESOURCE_NAME
import app.argusos.patches.shared.layout.branding.header.baseChangeHeaderPatch
...
private val logoResourceNames = arrayOf("argusos_header")

private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/ChangeHeaderPatch;"
