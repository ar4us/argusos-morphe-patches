...
package app.argusos.patches.youtube.layout.music
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/OverrideYouTubeMusicButtonsPatch;"
...
val overrideYouTubeMusicButtonsPatch = bytecodePatch(
    ...
    description = "Overrides YouTube Music buttons to open ArgusOS Music or any compatible third-party client.",
) {
    ...
    execute {
        PreferenceScreen.GENERAL.addPreferences(
            noTitleUnsortedPreferenceCategory(
                SwitchPreference(key = "argusos_override_youtube_music_buttons", summary = true),
                TextPreference(key = "argusos_music_package_name")
            )
        )
