...
val disableFullscreenGesturesPatch = bytecodePatch(
    ...
    val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/DisableFullscreenGesturesPatch;"
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_disable_fullscreen_gestures",
                sorting = Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("argusos_disable_fullscreen_pulled_up_gesture"),
                    SwitchPreference("argusos_disable_fullscreen_dragged_down_gesture"),
                    SwitchPreference("argusos_disable_fullscreen_sliding_down_gesture")
                )
            )
        )
