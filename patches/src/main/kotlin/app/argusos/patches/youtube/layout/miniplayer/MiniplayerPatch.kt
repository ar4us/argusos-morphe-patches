...
import app.argusos.patches.youtube.misc.playservice.is_21_17_or_greater
...
internal const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/MiniplayerPatch;"
...
val miniplayerPatch = bytecodePatch(
    ...
    execute {
        ...
        preferences += SwitchPreference("argusos_miniplayer_disable_resuming", summary = true)
        preferences += SwitchPreference("argusos_miniplayer_disable_drag_and_drop", summary = true)
        preferences += SwitchPreference("argusos_miniplayer_disable_horizontal_drag", summary = true)
        preferences += SwitchPreference("argusos_miniplayer_disable_rounded_corners")
        preferences += SwitchPreference("argusos_miniplayer_hide_overlay_buttons")
        preferences += TextPreference("argusos_miniplayer_width_dip", inputType = InputType.NUMBER)
        preferences += NonInteractivePreference(
            key = "argusos_miniplayer_opacity",
            tag = "app.argusos.extension.shared.settings.preference.SeekBarPreference",
        )
        preferences += SwitchPreference("argusos_miniplayer_disable_horizontal_drag_playback", summary = true)
        preferences += SwitchPreference("argusos_miniplayer_disable_horizontal_reposition", summary = true)
