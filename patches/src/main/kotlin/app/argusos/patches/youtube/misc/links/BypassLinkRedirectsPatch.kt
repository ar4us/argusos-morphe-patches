...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/BypassLinkRedirectsPatch;"
...
val bypassLinkRedirectsPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_bypass_link_redirects", summary = true),
        )
