...
import app.argusos.patches.shared.misc.litho.node.hookTreeNodeResult
...
import app.argusos.patches.shared.misc.spans.addSpanFilter
import app.argusos.patches.shared.misc.spans.inclusiveSpanPatch
import app.argusos.patches.youtube.layout.hide.shelves.hideHorizontalShelvesPatch
import app.argusos.patches.youtube.layout.hide.updatescreen.hideUpdateScreenPatch
...
import app.argusos.patches.youtube.misc.litho.node.treeNodeElementHookPatch
...
import app.argusos.patches.youtube.misc.playservice.is_21_11_or_greater
import app.argusos.patches.youtube.misc.playservice.is_21_20_or_greater
import app.argusos.patches.youtube.misc.playservice.is_21_25_or_greater
import app.argusos.patches.youtube.misc.playservice.versionCheckPatch
import app.argusos.patches.shared.misc.proto.hookElement
import app.argusos.patches.youtube.misc.proto.elementProtoParserHookPatch
...
private const val LAYOUT_COMPONENTS_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/LayoutComponentsFilter;"
private const val DESCRIPTION_COMPONENTS_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/DescriptionComponentsFilter;"
private const val COMMENTS_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/CommentsFilter;"
private const val CUSTOM_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/CustomFilter;"
private const val KEYWORD_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/KeywordContentFilter;"
private const val AISLIST_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/AiSListFilter;"
private const val SANITIZE_VIDEO_SUBTITLE_FILTER =
    "Lapp/argusos/extension/youtube/patches/spans/SanitizeVideoSubtitleFilter;"
private const val SEARCH_LINKS_FILTER =
    "Lapp/argusos/extension/youtube/patches/spans/SearchLinksFilter;"
        ...
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    ...
                    SwitchPreference("argusos_hide_attributes_section", summary = true),
                    SwitchPreference("argusos_hide_chapters_section"),
                    SwitchPreference("argusos_hide_corrections_section"),
                    SwitchPreference("argusos_hide_course_progress_section"),
                    SwitchPreference("argusos_hide_explore_section", summary = true),
                    SwitchPreference("argusos_hide_explore_course_section"),
                    SwitchPreference("argusos_hide_explore_podcast_section"),
                    SwitchPreference("argusos_hide_featured_channels_section"),
                    ...
                    SwitchPreference("argusos_hide_video_details_section")
                )
            ),
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    ...
                    SwitchPreference("argusos_hide_comments_filter_bar_options", summary = true),
                    SwitchPreference("argusos_hide_comments_gift_animation_and_cards"),
                    SwitchPreference("argusos_hide_comments_gift_button"),
                    SwitchPreference("argusos_hide_comments_info_button"),
                    SwitchPreference("argusos_hide_comments_live_chat_donators_bar"),
                    SwitchPreference("argusos_hide_comments_preview_comment", summary = true),
                    SwitchPreference("argusos_hide_comments_thanks_button"),
                    SwitchPreference("argusos_sanitize_comments_highlighted_search_links", summary = true)
                ),
            ...
            SwitchPreference("argusos_hide_info_panels", summary = true),
            SwitchPreference("argusos_hide_join_membership_button"),
            SwitchPreference("argusos_hide_live_chat_replay_button", summary = true),
            SwitchPreference("argusos_hide_medical_panels"),
            SwitchPreference("argusos_hide_snackbar"),
            SwitchPreference("argusos_hide_subscribers_community_guidelines"),
            SwitchPreference("argusos_hide_sync_button"),
            SwitchPreference("argusos_hide_timed_reactions", summary = true),
            SwitchPreference("argusos_hide_video_title", summary = true),
            SwitchPreference("argusos_sanitize_video_subtitle", summary = true)
        )
        ...
        PreferenceScreen.FEED.addPreferences(
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    ...
                    SwitchPreference("argusos_hide_keyword_content_comments"),
                    TextPreference("argusos_hide_keyword_content_phrases", inputType = InputType.TEXT_MULTI_LINE),
                    PreferenceCategory(
                        key = "argusos_hide_keyword_content_stats_category",
                        titleKey = "argusos_hide_stats_category_title",
                        sorting = Sorting.UNSORTED,
                        preferences = emptySet(),
                        tag = "app.argusos.extension.youtube.settings.preference.KeywordContentStatsPreferenceCategory"
                    ),
                    PreferenceCategory(
                        key = "argusos_hide_keyword_content_about_category",
                        titleKey = "argusos_hide_about_category_title",
                        sorting = Sorting.UNSORTED,
                        preferences = setOf(
                            NonInteractivePreference(
                                key = "argusos_hide_keyword_content_about",
                                titleKey = "argusos_hide_keyword_content_screen_title",
            ...
            PreferenceScreenPreference(
                key = "argusos_hide_aislist_screen",
                sorting = Sorting.UNSORTED,
                preferences = setOf(
                    PreferenceCategory(
                        key = "argusos_hide_aislist_blocklist_category",
                        sorting = Sorting.UNSORTED,
                        preferences = setOf(
                            SwitchPreference(
                                key = "argusos_hide_aislist_blocklist_home",
                                titleKey = "argusos_hide_aislist_hide_home_title"
                            ),
                            SwitchPreference(
                                key = "argusos_hide_aislist_blocklist_search",
                                titleKey = "argusos_hide_aislist_hide_search_title"
                            )

                        )
                    ),
                    PreferenceCategory(
                        key = "argusos_hide_aislist_warnlist_category",
                        sorting = Sorting.UNSORTED,
                        preferences = setOf(
                            SwitchPreference(
                                key = "argusos_hide_aislist_warnlist_home",
                                titleKey = "argusos_hide_aislist_hide_home_title"
                            ),
                            SwitchPreference(
                                key = "argusos_hide_aislist_warnlist_search",
                                titleKey = "argusos_hide_aislist_hide_search_title"
                            )
                        )
                    ),
                    PreferenceCategory(
                        key = "argusos_hide_aislist_stats_category",
                        titleKey = "argusos_hide_stats_category_title",
                        sorting = Sorting.UNSORTED,
                        preferences = emptySet(),
                        tag = "app.argusos.extension.youtube.settings.preference.AiSListStatsPreferenceCategory"
                    ),
                    PreferenceCategory(
                        key = "argusos_hide_aislist_about_category",
                        titleKey = "argusos_hide_about_category_title",
                        sorting = Sorting.UNSORTED,
                        preferences = setOf(
                            NonInteractivePreference(
                                key = "argusos_hide_aislist_about",
                                titleKey = "argusos_hide_aislist_screen_title",
                                tag = "app.argusos.extension.shared.settings.preference.BulletPointPreference"
                            ),
                            NonInteractivePreference(
                                key = "argusos_hide_aislist_attribution",
                                tag = "app.argusos.extension.shared.settings.preference.AiSListAttributionPreference",
                                selectable = true
                            )
                        )
                    )
            ...
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    SwitchPreference("argusos_hide_filter_bar_in_comments"),
                    SwitchPreference("argusos_hide_filter_bar_in_feed"),
                    SwitchPreference("argusos_hide_filter_bar_in_related_videos"),
                    SwitchPreference("argusos_hide_filter_bar_in_search"),
                    SwitchPreference("argusos_hide_filter_bar_in_history")
                )
            ),
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    ...
                    SwitchPreference("argusos_hide_links_preview", summary = true),
                    SwitchPreference("argusos_hide_members_shelf", summary = true),
                    SwitchPreference("argusos_hide_posts_shelf"),
                    SwitchPreference("argusos_hide_store_button"),
                    SwitchPreference("argusos_hide_subscribe_button_in_channel_page")
                )
            ),
            SwitchPreference("argusos_hide_album_cards", summary = true),
            SwitchPreference("argusos_hide_artist_cards", summary = true),
            SwitchPreference("argusos_hide_auto_dubbed_label"),
            SwitchPreference("argusos_hide_community_posts"),
            SwitchPreference("argusos_hide_compact_banner", summary = true),
            if (is_20_26_or_greater) {
                ListPreference("argusos_hide_expandable_card")
            } else {
                ListPreference(
                    key = "argusos_hide_expandable_card",
                    entriesKey = "argusos_hide_expandable_card_legacy_entries",
                    entryValuesKey = "argusos_hide_expandable_card_legacy_entry_values"
                )
            },
            noTitleUnsortedPreferenceCategory(
            ...
            noTitleUnsortedPreferenceCategory(
                SwitchPreference("argusos_hide_account_menu"),
                TextPreference(
                    "argusos_hide_account_menu_filter_strings",
                    inputType = InputType.TEXT_MULTI_LINE
                )
            ),
            SwitchPreference("argusos_hide_floating_microphone_button", summary = true),
            SwitchPreference("argusos_hide_horizontal_shelves", summary = true),
            SwitchPreference("argusos_hide_hyped_label"),
            SwitchPreference("argusos_hide_image_shelf", summary = true),
            SwitchPreference("argusos_hide_latest_videos_button", summary = true),
            SwitchPreference("argusos_hide_mix_playlists"),
            SwitchPreference("argusos_hide_movies_section"),
            SwitchPreference("argusos_hide_notify_me_button", summary = true),
            SwitchPreference("argusos_hide_playables", summary = true),
            SwitchPreference("argusos_hide_search_term_thumbnails", summary = true),
            SwitchPreference("argusos_hide_show_more_button", summary = true),
            SwitchPreference("argusos_hide_subscribed_channels_bar"),
            SwitchPreference("argusos_hide_surveys", summary = true),
            SwitchPreference("argusos_hide_ticket_shelf"),
            SwitchPreference(
                "argusos_hide_upload_time",
                summary = true,
                tag = "app.argusos.extension.shared.settings.preference.BulletPointSwitchPreference"
            ),
            SwitchPreference("argusos_hide_video_thumbnail"),
            SwitchPreference("argusos_hide_video_recommendation_labels", summary = true),
            SwitchPreference(
                "argusos_hide_view_count",
                summary = true,
                tag = "app.argusos.extension.shared.settings.preference.BulletPointSwitchPreference"
            ),
            SwitchPreference("argusos_hide_web_search_results", summary = true),
            SwitchPreference("argusos_hide_youtube_doodles", summary = true)
        )
