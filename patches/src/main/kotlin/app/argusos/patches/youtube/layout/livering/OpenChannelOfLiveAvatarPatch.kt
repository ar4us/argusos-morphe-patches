package app.argusos.patches.youtube.layout.livering
...
import app.argusos.patches.youtube.layout.shortsplayer.ShortsPlaybackIntentFingerprint
import app.argusos.patches.youtube.layout.shortsplayer.ShortsPlaybackIntentFingerprintLegacy
...
import app.argusos.patches.youtube.video.information.PlaybackStartDescriptorToStringFingerprint
import app.morphe.util.addInstructionsAtControlFlowLabel
import app.morphe.util.getFreeRegisterProvider
import com.android.tools.smali.dexlib2.iface.instruction.OneRegisterInstruction

private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/OpenChannelOfLiveAvatarPatch;"
...
val openChannelOfLiveAvatarPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.FEED.addPreferences(
            SwitchPreference("argusos_open_channel_of_live_avatar", summary = true)
        )
