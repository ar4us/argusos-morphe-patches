...
package app.argusos.patches.youtube.interaction.reload
    ...
    execute {
        copyResources(
            ...
            ResourceGroup(
                ...
                "argusos_reload_video_button.xml",
                "argusos_reload_video_button_bold.xml",
            ),
        )
    }
}
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/LoadVideoPatch;"

private const val EXTENSION_PLAYER_INTERFACE =
    $$"Lapp/argusos/extension/youtube/patches/LoadVideoPatch$PlayerInterface;"

private const val EXTENSION_BUTTON =
    "Lapp/argusos/extension/youtube/videoplayer/ReloadVideoButton;"
...
val reloadVideoButtonPatch = bytecodePatch(
    ...
    dependsOn(
        ...
        bytecodePatch {
            finalize {
                addTopControl(
                    "reloadbutton",
                    "@+id/argusos_reload_video_button",
                    "@+id/argusos_reload_video_button"
                )
            }
        }
    ...
    execute {
        addPlayerOverlayPreferences(
            SwitchPreference("argusos_reload_video_button")
        )
