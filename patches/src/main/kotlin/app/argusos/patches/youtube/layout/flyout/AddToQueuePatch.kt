...
package app.argusos.patches.youtube.layout.flyout
...
import app.argusos.patches.youtube.layout.hide.general.ContextualMenuItemBuilderFingerprint
import app.argusos.patches.youtube.layout.hide.general.ContextualMenuItemBuilderOnClickFingerprint
...
import app.argusos.patches.youtube.misc.playservice.is_21_05_or_greater
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/AddToQueuePatch;"

private const val EXTENSION_UTILS_CLASS =
    "Lapp/argusos/extension/youtube/patches/utils/FlyoutUtils;"

private const val EXTENSION_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/ChannelPageFlyoutFilter;"

private const val EXTENSION_FLYOUT_MENU_VIDEO_ID_INTERFACE =
    $$"Lapp/argusos/extension/youtube/patches/utils/FlyoutUtils$FlyoutMenuVideoIdInterface;"

private const val EXTENSION_PROTOCOL_BUFFER_INTERFACE =
    $$"Lapp/argusos/extension/youtube/patches/utils/FlyoutUtils$ProtocolBufferFieldInterface;"
...
val addToQueuePatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.FEED.addPreferences(
            SwitchPreference("argusos_queue_override_flyout_menu", summary = true)
        )
