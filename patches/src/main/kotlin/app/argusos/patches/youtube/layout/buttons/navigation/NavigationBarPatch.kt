...
import app.argusos.patches.shared.misc.fix.proto.immutableMethodRef
import app.argusos.patches.shared.misc.fix.proto.mutableCopyMethodRef
import app.argusos.patches.shared.misc.fix.proto.parseByteArrayMethodRef
...
import app.argusos.patches.youtube.misc.navigation.addBottomBarContainerHook
...
import app.argusos.patches.youtube.misc.toolbar.hookToolBar
import app.argusos.patches.youtube.misc.toolbar.toolBarHookPatch
import app.argusos.patches.youtube.shared.ActionBarSearchResultsFingerprint
...
private const val EXTENSION_SETTING_INTERFACE =
    $$"Lapp/argusos/extension/youtube/patches/NavigationBarPatch$SettingsController;"
...
val navigationBarPatch = bytecodePatch(
    ...
    execute {
        val navPreferences = mutableSetOf(
            ...
            SwitchPreference("argusos_show_search_button"),
            ListPreference("argusos_show_search_button_index"),
            SwitchPreference("argusos_show_settings_button"),
            ListPreference("argusos_show_settings_button_index"),
            SwitchPreference("argusos_show_settings_button_type", summary = true),
            SwitchPreference("argusos_swap_create_with_notifications_button", summary = true),
            SwitchPreference("argusos_hide_navigation_button_labels"),
            SwitchPreference("argusos_narrow_navigation_buttons", summary = true),
            SwitchPreference("argusos_hide_navigation_bar"),
        )

        navPreferences += SwitchPreference("argusos_disable_translucent_navigation_bar_light", summary = true)
        navPreferences += SwitchPreference("argusos_disable_translucent_navigation_bar_dark", summary = true)

        PreferenceScreen.GENERAL.addPreferences(
            SwitchPreference("argusos_disable_translucent_status_bar", summary = true)
        )

        navPreferences += SwitchPreference("argusos_navigation_bar_animations", summary = true)

        if (is_20_31_or_greater) {
            navPreferences += SwitchPreference("argusos_disable_auto_hide_navigation_bar", summary = true)
        }
        ...
        val toolbarPreferences = mutableSetOf(
            SwitchPreference("argusos_hide_toolbar_cast_button"),
            SwitchPreference("argusos_hide_toolbar_chat_button"),
            SwitchPreference("argusos_hide_toolbar_create_button"),
            SwitchPreference("argusos_hide_toolbar_microphone_button"),
            SwitchPreference("argusos_hide_toolbar_notification_button"),
            SwitchPreference("argusos_hide_toolbar_search_button"),
            SwitchPreference("argusos_show_toolbar_settings_button"),
            ListPreference("argusos_show_toolbar_settings_button_index"),
            SwitchPreference("argusos_show_toolbar_settings_button_type", summary = true)
        )
        if (!is_20_31_or_greater) {
