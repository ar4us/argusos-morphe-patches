...
import app.argusos.patches.shared.misc.litho.context.EXTENSION_CONTEXT_INTERFACE
import app.argusos.patches.shared.misc.litho.context.conversionContextClassDef
...
import app.argusos.patches.youtube.shared.RollingNumberTextViewAnimationUpdateFingerprint
...
private const val EXTENSION_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/ReturnYouTubeDislikeFilter;"
...
val returnYouTubeDislikePatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.RETURN_YOUTUBE_DISLIKE.addPreferences(
            ...
            SwitchPreference("argusos_ryd_dislike_percentage", summary = true),
            SwitchPreference("argusos_ryd_compact_layout", summary = true),
            SwitchPreference("argusos_ryd_estimated_like", summary = true),
            SwitchPreference("argusos_ryd_toast_on_connection_error", summary = true),
