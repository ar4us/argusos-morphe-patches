...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/CaptionCookiesPatch;"
...
internal val captionCookiesPatch = bytecodePatch(
    ...
    execute {
        settingsMenuCaptionGroup.addAll(listOf(
            SwitchPreference("argusos_set_caption_cookies", summary = true),
            TextPreference(
                "argusos_caption_cookies",
                inputType = InputType.TEXT_MULTI_LINE
            ),
            NonInteractivePreference(
                key = "argusos_get_caption_cookies",
                tag = "app.argusos.extension.youtube.settings.preference.GetCaptionCookiesPreference",
            )
        ))
