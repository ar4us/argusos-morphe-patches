...
import app.argusos.patches.youtube.video.information.playerStatusMethodRef
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/LoopVideoPatch;"
...
val loopVideoPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            ...
            SwitchPreference("argusos_do_not_remember_loop_video", summary = true)
        )
