...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/OpenLinksExternallyPatch;"
...
val openLinksExternallyPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.MISC.addPreferences(
            SwitchPreference("argusos_external_browser", summary = true),
        )
