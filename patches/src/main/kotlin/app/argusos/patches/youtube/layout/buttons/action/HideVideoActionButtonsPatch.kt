...
import app.argusos.patches.youtube.misc.fix.videoactionbar.restoreOldVideoActionBarPatch
...
import app.argusos.patches.youtube.shared.WatchNextResponseParserFingerprint
...
private const val VIDEO_ACTION_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/VideoActionButtonsFilter;"
private const val QUICK_ACTIONS_FILTER =
    "Lapp/argusos/extension/youtube/patches/components/QuickActionButtonsFilter;"
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_action_buttons_screen",
                preferences = setOf(
                    PreferenceCategory(
                        titleKey = "argusos_portrait_buttons",
                        preferences = setOf(
                            SwitchPreference("argusos_disable_like_subscribe_glow", summary = true),
                            SwitchPreference("argusos_hide_action_bar"),
                            SwitchPreference("argusos_hide_ask_button"),
                            SwitchPreference("argusos_hide_clip_button", summary = true),
                            SwitchPreference("argusos_hide_comments_button"),
                            SwitchPreference("argusos_hide_connect_button"),
                            ...
                            SwitchPreference("argusos_hide_more_button"),
                    ...
                    PreferenceCategory(
                        titleKey = "argusos_fullscreen_buttons",
                        preferences = setOf(
                            NonInteractivePreference(
                                key = "argusos_quick_actions_top_margin",
                                tag = "app.argusos.extension.shared.settings.preference.SeekBarPreference"
                            ),
                            SwitchPreference("argusos_hide_quick_actions"),
                            SwitchPreference("argusos_hide_quick_actions_ask_button"),
                            SwitchPreference("argusos_hide_quick_actions_comments_button"),
                            SwitchPreference("argusos_hide_quick_actions_dislike_button"),
                            SwitchPreference("argusos_hide_quick_actions_like_button"),
                            SwitchPreference("argusos_hide_quick_actions_live_chat_button"),
                            SwitchPreference("argusos_hide_quick_actions_mix_button"),
                            SwitchPreference("argusos_hide_quick_actions_more_button"),
                            SwitchPreference("argusos_hide_quick_actions_more_videos_button"),
                            SwitchPreference("argusos_hide_quick_actions_playlist_button"),
                            SwitchPreference("argusos_hide_quick_actions_save_button"),
                            SwitchPreference("argusos_hide_quick_actions_share_button")
                        )
                    )
                )
            )
