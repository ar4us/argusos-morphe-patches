...
import app.argusos.patches.youtube.misc.playservice.is_21_10_or_greater
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/ShortsAutoplayPatch;"
...
val shortsAutoplayPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_shorts_autoplay", summary = true),
            SwitchPreference("argusos_shorts_autoplay_background", summary = true)
        )
