...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/LivestreamDVRPatch;"
    ...
    execute {
        PreferenceScreen.SEEKBAR.addPreferences(
            noTitleUnsortedPreferenceCategory(
                SwitchPreference("argusos_livestream_dvr", summary = true),
                SwitchPreference("argusos_expand_livestream_dvr_duration", summary = true)
            )
        )
