package app.argusos.patches.youtube.layout.hide.ambientmode
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/AmbientModePatch;"
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_ambient_mode_screen",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("argusos_bypass_ambient_mode_restrictions", summary = true),
                    SwitchPreference("argusos_disable_ambient_mode"),
