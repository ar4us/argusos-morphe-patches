...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/AutoCaptionsPatch;"
    ...
    execute {
        settingsMenuCaptionGroup.add(
            if (is_20_26_or_greater) {
                ListPreference("argusos_auto_captions_style")
            } else {
                ListPreference(
                    key = "argusos_auto_captions_style",
                    entriesKey = "argusos_auto_captions_style_legacy_entries",
                    entryValuesKey = "argusos_auto_captions_style_legacy_entry_values"
                )
            }
        )
