package app.argusos.patches.youtube.layout.shortsnoresume
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/youtube/patches/DisableShortsResumingOnStartupPatch;"
...
val disableShortsResumingOnStartupPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.SHORTS.addPreferences(
            SwitchPreference("argusos_disable_shorts_resuming_on_startup"),
        )
