...
import app.argusos.patches.youtube.misc.playservice.is_20_30_or_greater
...
internal const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/LegacyPlayerControlsPatch;"
    ...
    execute {
        if (is_20_31_or_greater) {
            PreferenceScreen.PLAYER.addPreferences(
                SwitchPreference("argusos_restore_old_player_buttons", summary = true)
            )
        }
