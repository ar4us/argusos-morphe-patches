...
private val downloadsResourcePatch = resourcePatch {
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                ...
                preferences = setOf(
                    SwitchPreference("argusos_external_downloader", summary = true),
        ...
        copyResources(
            ...
            ResourceGroup(
                "drawable",
                "argusos_yt_download_button.xml",
                "argusos_yt_download_button_bold.xml",
            )
        )
    }
    ...
    finalize {
        addTopControl("downloads",
            "@+id/argusos_external_download_button",
            "@+id/argusos_external_download_button")
    }
}

private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/DownloadsPatch;"

private const val EXTENSION_BUTTON = "Lapp/argusos/extension/youtube/videoplayer/ExternalDownloadButton;"
