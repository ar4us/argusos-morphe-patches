...
import app.argusos.patches.shared.layout.theme.createNotifDrawable
import app.argusos.patches.shared.layout.theme.darkThemeBackgroundColorOption
import app.argusos.patches.shared.layout.theme.lightThemeBackgroundColorOption
import app.argusos.patches.shared.layout.theme.patchCountTextColor
...
import app.argusos.patches.youtube.misc.playservice.is_21_08_or_greater
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/youtube/patches/theme/ThemePatch;"
...
val themePatch = baseThemePatch(
        ...
        val themeResourcePatch = resourcePatch {
            ...
            execute {
                ...
                if (isMaterialYouLight) {
                    ...
                    createNotifDrawable(resDir, "drawable/argusos_notif_dot_light.xml", lightDotColor, "oval")
                    createNotifDrawable(resDir, "drawable/argusos_notif_count_light.xml", lightCountBgColor, "rectangle", hasCorners = true)
                            ...
                            resources.forEachChildElement { style ->
                                ...
                                val overrides: Map<String, String> = when (style.getAttribute("name")) {
                                    "PivotBar.Default" -> mapOf(
                                        "dotBackground" to "@drawable/argusos_notif_dot_light",
                                        "countBackground" to "@drawable/argusos_notif_count_light"
                                    )
    ...
    executeBlock = {
        PreferenceScreen.GENERAL.addPreferences(
            SwitchPreference("argusos_gradient_loading_screen", summary = true)
        )
