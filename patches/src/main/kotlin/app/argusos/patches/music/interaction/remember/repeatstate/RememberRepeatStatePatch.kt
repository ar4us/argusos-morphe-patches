...
package app.argusos.patches.music.interaction.remember.repeatstate
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/music/patches/RememberRepeatStatePatch;"
...
val rememberRepeatStatePatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_remember_repeat_state"),
        )
