...
package app.argusos.patches.music.interaction.dislikeredirection
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/music/patches/DisableDislikeRedirectionPatch;"
...
val disableDislikeRedirectionPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_disable_dislike_redirection", summary = true)
        )
