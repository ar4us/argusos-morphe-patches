 ...
 */
package app.argusos.patches.music.interaction.crossfade
...
import app.argusos.patches.music.misc.playservice.is_9_00_or_greater
...
private const val EXTENSION_CLASS =
    "Lapp/argusos/extension/music/patches/CrossfadeManager;"

private const val COORDINATOR_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$PlayerCoordinatorAccess;"
private const val EXO_PLAYER_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$ExoPlayerAccess;"
private const val SESSION_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$SessionAccess;"
private const val FACTORY_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$PlayerFactoryAccess;"
private const val SHARED_STATE_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$SharedStateAccess;"
private const val SHARED_CALLBACK_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$SharedCallbackAccess;"
private const val VIDEO_SURFACE_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$VideoSurfaceAccess;"
private const val MEDIALIB_PLAYER_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$MedialibPlayerAccess;"
private const val VIDEO_TOGGLE_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$VideoToggleAccess;"
private const val DELEGATE_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$DelegateAccess;"
private const val LISTENER_WRAPPER_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/CrossfadeManager$ListenerWrapperAccess;"
...
private val crossfadeBannerResourcePatch = resourcePatch {
    execute {
        copyResources(
            "crossfade",
            ResourceGroup("drawable-nodpi", "argusos_crossfade_about_banner.webp"),
            ResourceGroup("layout", "argusos_crossfade_about_banner.xml"),
        )
    }
}
    ...
    execute {
        ...
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_music_crossfade_screen",
                sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                preferences = setOf(
                    SwitchPreference("argusos_music_crossfade_enabled"),
                    ListPreference("argusos_music_crossfade_curve"),
                    NonInteractivePreference(
                        key = "argusos_music_crossfade_curve_preview",
                        summaryKey = null,
                        tag = "app.argusos.extension.music.settings.preference.CrossfadeCurvePreference",
                    ),
                    ListPreference("argusos_music_crossfade_duration"),
                    SwitchPreference("argusos_music_crossfade_on_skip", summary = true),
                    SwitchPreference("argusos_music_crossfade_on_auto_advance", summary = true),
                    SwitchPreference("argusos_music_crossfade_session_control", summary = true),
                    ...
                    PreferenceScreenPreference(
                        key = "argusos_music_crossfade_about",
                        sorting = PreferenceScreenPreference.Sorting.UNSORTED,
                        preferences = setOf(
                            // Header banner (full-width crossfade graphic) — custom
                            // ImageView layout, no title/summary.
                            NonInteractivePreference(
                                key = "argusos_music_crossfade_about_banner",
                                titleKey = "argusos_music_crossfade_about_banner_title",
                                summaryKey = null,
                                layout = "@layout/argusos_crossfade_about_banner",
                            ),
                            NonInteractivePreference("argusos_music_crossfade_about_how"),
                            NonInteractivePreference("argusos_music_crossfade_about_best"),
                            NonInteractivePreference("argusos_music_crossfade_about_quirks"),
                            NonInteractivePreference("argusos_music_crossfade_about_known"),
                            NonInteractivePreference("argusos_music_crossfade_about_unsupported"),
                            NonInteractivePreference("argusos_music_crossfade_about_credit"),
                        )
                    )
                )
            )
