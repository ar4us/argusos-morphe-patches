...
package app.argusos.patches.music.layout.buttons.action
...
import app.argusos.patches.music.misc.litho.node.treeNodeElementHookPatch
...
private const val ACTION_BUTTONS_FILTER =
    "Lapp/argusos/extension/music/patches/components/MusicActionButtonsFilter;"

private const val EXTENSION_BUTTON_PROTO_INTERFACE =
    $$"Lapp/argusos/extension/music/patches/components/MusicActionButtonsFilter$ButtonProtoBufferInterface;"
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            PreferenceScreenPreference(
                key = "argusos_music_action_buttons_screen",
                preferences = setOf(
                    SwitchPreference("argusos_music_hide_action_bar"),
                    SwitchPreference("argusos_music_hide_like_dislike_button"),
                    SwitchPreference("argusos_music_hide_comments_button"),
                    SwitchPreference("argusos_music_hide_lyrics_button"),
                    SwitchPreference("argusos_music_hide_share_button"),
                    SwitchPreference("argusos_music_hide_save_button"),
                    SwitchPreference("argusos_music_hide_download_button"),
                    SwitchPreference("argusos_music_hide_radio_button")
                )
            )
        )
