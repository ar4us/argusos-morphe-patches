...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/music/patches/ChangeMiniplayerColorPatch;"
...
val changeMiniplayerColorPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_change_miniplayer_color", summary = true),
            SwitchPreference("argusos_music_change_navigation_bar_color", summary = true)
        )
