...
package app.argusos.patches.music.interaction.remember.shufflestate
...
import app.argusos.patches.music.misc.playservice.is_8_03_or_greater
...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/music/patches/RememberShuffleStatePatch;"
...
val rememberShuffleStatePatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_remember_shuffle_state")
        )
