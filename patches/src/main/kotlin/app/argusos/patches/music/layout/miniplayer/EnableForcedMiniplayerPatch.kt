...
private const val EXTENSION_CLASS = "Lapp/argusos/extension/music/patches/EnableForcedMiniplayerPatch;"
...
val enableForcedMiniplayerPatch = bytecodePatch(
    ...
    execute {
        PreferenceScreen.PLAYER.addPreferences(
            SwitchPreference("argusos_music_enable_forced_miniplayer", summary = true)
        )
